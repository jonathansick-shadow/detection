...
DetectionSet<ImagePixelType, MaskPixelType>::DetectionSet(
    ...
    const typename lsst::fw::Image<ImagePixelType>::ImagePtrT img = maskedImg.getImage();
...
namespace {
    ...
    public:
        ...
        Startspan(const Span *span, lsst::fw::Mask<MaskPixelType> *mask, const DIRECTION dir);
    ...
    Startspan<MaskPixelType>::Startspan(const Span *span, // The span in question
                         lsst::fw::Mask<MaskPixelType> *mask, // Pixels that we've already detected
    ...
    class StartspanSet {
    public:
        StartspanSet(lsst::fw::MaskedImage<ImagePixelType, MaskPixelType>& image) :
