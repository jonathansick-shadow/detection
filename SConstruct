...
env.libs["detection"] +=  env.getlibs("afw daf_base daf_data daf_persistence pex_logging pex_exceptions pex_policy security afw boost utils wcslib")
#
